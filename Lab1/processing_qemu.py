...
print("\nOnly 100 points", file=open("result/qemu_result.txt", "a"))
ms_size = 0.5
...
coef_gcc.append(round(z[0]*10**6,5))
print("qemu_gcc_O0_100 ",round(z[0]*10**6,5), " us/val", file=open("result/qemu_result.txt", "a"))

z = np.polyfit(gcc_x[1][:100], gcc_y[1][:100], 1)
p = np.poly1d (z)
plt.plot (gcc_x[1][:100], p(gcc_x[1][:100]), linewidth=0.2, color = "dodgerblue")
coef_gcc.append(round(z[0]*10**6,5))
print("qemu_gcc_O1_100 ",round(z[0]*10**6,5), " us/val", file=open("result/qemu_result.txt", "a"))

z = np.polyfit(gcc_x[2][:100], gcc_y[2][:100], 1)
p = np.poly1d (z)
plt.plot (gcc_x[2][:100], p(gcc_x[2][:100]), linewidth=0.2, color = "royalblue")
coef_gcc.append(round(z[0]*10**6,5))
print("qemu_gcc_O2_100 ",round(z[0]*10**6,5), " us/val", file=open("result/qemu_result.txt", "a"))

z = np.polyfit(gcc_x[3][:100], gcc_y[3][:100], 1)
p = np.poly1d (z)
plt.plot (gcc_x[3][:100], p(gcc_x[3][:100]), linewidth=0.2, color = "navy")
coef_gcc.append(round(z[0]*10**6,5))
print("qemu_gcc_O3_100 ",round(z[0]*10**6,5), " us/val", file=open("result/qemu_result.txt", "a"))
...
coef_llvm.append(round(z[0]*10**6,5))
print("qemu_llvm_O0_100 ",round(z[0]*10**6,5), " us/val", file=open("result/qemu_result.txt", "a"))

z = np.polyfit(llvm_x[1][:100], llvm_y[1][:100], 1)
p = np.poly1d (z)
plt.plot (llvm_x[1][:100], p(llvm_x[1][:100]), linewidth=0.2, color = "firebrick")
coef_llvm.append(round(z[0]*10**6,5))
print("qemu_llvm_O1_100 ",round(z[0]*10**6,5), " us/val", file=open("result/qemu_result.txt", "a"))

z = np.polyfit(llvm_x[2][:100], llvm_y[2][:100], 1)
p = np.poly1d (z)
plt.plot (llvm_x[2][:100], p(llvm_x[2][:100]), linewidth=0.2, color = "red")
coef_llvm.append(round(z[0]*10**6,5))
print("qemu_llvm_O2_100 ",round(z[0]*10**6,5), " us/val", file=open("result/qemu_result.txt", "a"))

z = np.polyfit(llvm_x[3][:100], llvm_y[3][:100], 1)
p = np.poly1d (z)
plt.plot (llvm_x[3][:100], p(llvm_x[3][:100]), linewidth=0.2, color = "maroon")
coef_llvm.append(round(z[0]*10**6,5))
print("qemu_llvm_O3_100 ",round(z[0]*10**6,5), " us/val", file=open("result/qemu_result.txt", "a"))
...
plt.xlabel("Len of massive")
plt.ylabel("Time, s")
plt.savefig("result/qemu_gcc_llvm_only_100.png")